...
const _defaultKeywords = '19th Century Paintings, Bedford Fine Art Gallery, 19th Century Art for Sale'

export const getMetaTitleAndDescriptionAndKeywords = ({ content, defaultTitle, defaultDescription, defaultKeywords }) => {
    if (!content) {
        content = {}
    }
    ...
    return {
        ...
        keywords: content.metaKeywords || defaultKeywords || _defaultKeywords,
    }
}
