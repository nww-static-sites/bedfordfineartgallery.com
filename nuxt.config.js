export default {
    ...
    image: {
        ...
        providers: {
            bedford: {
                provider: '~/providers/bedford-img',
                options: {
                    baseURL: 'https://img.bedfordfineartgallery.com',
                },
            },
        },
        domains: ['img.bedfordfineartgallery.com'],
    },
    sitemap: {
