    ...
    <div>
        ...
        " />
                    ...
                    <div class="mobile_1">
                        ...
                        <p>
                            It is always nice to share brief value-added information about once-a-month with those who
                            share our passion for fine art.
                        </p>
                        <p style="text-align: left; padding-top: 20px">
                            <span style="display: block; padding-bottom: 10px; font-weight: bold">Here's what a customer
                                said:</span>"Thank you for including me on your mailing list. Every time I see Bedford Fine
                            Art Gallery
