...
3. Keep the removed Cloudinary media library out of `static/admin/config.yml` before unfreezing the CMS.
...
- Do not restore the Cloudinary media library after cutover.
